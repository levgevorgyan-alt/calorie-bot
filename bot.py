...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "Just type what you ate and I'll estimate the calories:\n"
        ...
        "  example: /today\n\n"
        "/week - see a day-by-day summary for the last 7 days\n"
        "  example: /week\n\n"
        "/setlimit <kcal> - set your personal daily calorie limit\n"
        "  example: /setlimit 2200\n"
        "  (default is 1800 kcal)\n\n"
        "/limit - check your current daily limit\n"
        "  example: /limit\n\n"
        "\U0001f4a7 WATER TRACKING\n\n"
        "/water <ml> - log water intake in milliliters\n"
        "  example: /water 500\n"
        "  example: /water 250\n\n"
        "/watertoday - check how much water you've had today\n"
        "  example: /watertoday\n"
        "  (daily target: 2000ml)\n\n"
        "/reminders on - turn on water reminders in this chat\n"
        "/reminders off - turn them off\n"
        "  Reminders are sent at 11:00, 14:00, 16:00, 18:00, 20:00 UTC\n\n"
        ...
        "  Only affects your own data, not other users."
    )
